...
convert $saveDir$tempName  -fill white  -undercolor '#00000080' -font Liberation-Sans -pointsize 24 -gravity Southeast -annotate +0+86 " $annotation " $deskDir$picFileName
...
DISPLAY=:0 feh --bg-scale $deskDir$picFileName
